...
public class BusiConst {
    public static final String HELLO_TOPIC  = "hello-topic-1";

    public static final int CONCURRENT_PARTITIONS_COUNT = 2;
    public static final String CONCURRENT_USER_INFO_TOPIC = "concurrent-test-4";

    public static final String SELF_SERIAL_TOPIC = "self-serial-1";

    public static final String SELF_PARTITION_TOPIC = "self-partition-2";
